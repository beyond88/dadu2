...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    if (this.variants.length) {
      ...
      this.variantList = this.variants.map(function (v, index) {
        var _v$id, _v$name, _v$sku, _v$price, _v$customer_buying_pr, _v$weight, _v$dimension_l, _v$dimension_w, _v$dimension_d;
        var errors = {};
        Object.keys(_this.validationErrors).forEach(function (key) {
          var match = key.match(/^variants\.(\d+)\.(.+)$/);
          if (match && Number(match[1]) === index) {
            errors[match[2]] = _this.validationErrors[key];
          }
        });
        return {
          id: (_v$id = v.id) !== null && _v$id !== void 0 ? _v$id : null,
          name: (_v$name = v.name) !== null && _v$name !== void 0 ? _v$name : "",
          sku: (_v$sku = v.sku) !== null && _v$sku !== void 0 ? _v$sku : "",
          price: (_v$price = v.price) !== null && _v$price !== void 0 ? _v$price : "",
          customer_buying_price: (_v$customer_buying_pr = v.customer_buying_price) !== null && _v$customer_buying_pr !== void 0 ? _v$customer_buying_pr : "",
          weight: (_v$weight = v.weight) !== null && _v$weight !== void 0 ? _v$weight : "",
          dimension_l: (_v$dimension_l = v.dimension_l) !== null && _v$dimension_l !== void 0 ? _v$dimension_l : "",
          dimension_w: (_v$dimension_w = v.dimension_w) !== null && _v$dimension_w !== void 0 ? _v$dimension_w : "",
          dimension_d: (_v$dimension_d = v.dimension_d) !== null && _v$dimension_d !== void 0 ? _v$dimension_d : "",
          // store IDs for form submission
          attribute_items: (v.attribute_items || []).map(function (ai) {
            return ai.id;
          }),
      ...
      var attrMap = {}; // { attrId: { itemId: itemObj, ... }, ... }
      this.variants.forEach(function (v) {
        (v.attribute_items || []).forEach(function (ai) {
          var attrId = String(ai.attribute_id);
      ...
      Object.keys(attrMap).forEach(function (attrId) {
        var arr = Object.values(attrMap[attrId]);
        // use Vue.set to make it reactive
        _this.$set(_this.selectedAttributeValues, attrId, arr);
      });

      // Set selectedAttributes (attribute sets) based on keys present in selectedAttributeValues
      this.selectedAttributes = this.attributes.filter(function (attr) {
        return Object.prototype.hasOwnProperty.call(_this.selectedAttributeValues, String(attr.id));
      });
  ...
  methods: {
    loadAttributeItems: function loadAttributeItems() {
      var _this2 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _iterator, _step, attr, res, selected;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                // load attribute items for each selected attribute if not already loaded
                _iterator = _createForOfIteratorHelper(_this2.selectedAttributes);
                _context.prev = 1;
                _iterator.s();
              case 3:
                ...
                attr = _step.value;
                if (_this2.attributeItems[attr.id]) {
                  _context.next = 20;
                  break;
                }
                _context.prev = 6;
                _context.next = 9;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get("/admin/api/attribute-items/".concat(attr.id));
              case 9:
                res = _context.sent;
                // res.data should be an array of { id, name, attribute_id, ... }
                _this2.$set(_this2.attributeItems, attr.id, res.data);
                ...
                selected = _this2.selectedAttributeValues[String(attr.id)];
                if (selected && selected.length) {
                  (function () {
                    // map of loaded options by id for quick lookup
                    var optById = {};
                    res.data.forEach(function (o) {
                      return optById[o.id] = o;
                    });
                    // replace each selected entry with the option object from res.data (if exists)
                    var normalized = selected.map(function (s) {
                      return optById[s.id] ? optById[s.id] : s;
                    })
                    // dedupe just in case
                    ...
                    _this2.$set(_this2.selectedAttributeValues, String(attr.id), normalized);
                  })();
                }
                _context.next = 18;
                break;
              ...
              case 20:
                (function () {
                  ...
                  var selected = _this2.selectedAttributeValues[String(attr.id)] || [];
                  var optById = {};
                  _this2.attributeItems[attr.id].forEach(function (o) {
                    return optById[o.id] = o;
                  });
                  var normalized = selected.map(function (s) {
                    return optById[s.id] ? optById[s.id] : s;
    ...
    generateVariants: function generateVariants() {
      ...
      var combine = function combine(arr) {
        return arr.length === 1 ? arr[0].map(function (v) {
          return [v];
      ...
      var combos = combine(values);

      // build new variants from combos
      this.variantList = combos.map(function (combo, idx) {
        var variantName = combo.map(function (val) {
          return val.name;
        }).join("-");
        var attributeItemsIds = combo.map(function (val) {
          return val.id;
        });
        return {
          id: null,
          // new variant (no db id yet)
          name: variantName,
          sku: "".concat(variantName, "-").concat(_this3.product.id),
          price: "",
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
    ...
    on: {
      input: _vm.loadAttributeItems
    },
    model: {
      value: _vm.selectedAttributes,
      callback: function callback($$v) {
        _vm.selectedAttributes = $$v;
      },
      expression: "selectedAttributes"
    }
  }), _vm._v(" "), _c("small", {
    staticClass: "text-info"
  }, [_vm._v("\n      N.B: Select Attribute sets of this product to add attribute values\n    ")])], 1), _vm._v(" "), _vm._l(_vm.selectedAttributes, function (attr) {
    return _c("div", {
      key: attr.id,
      staticClass: "mb-3"
    }, [_c("label", [_c("strong", [_vm._v(_vm._s(attr.name))])]), _vm._v(" "), _c("multiselect", {
      attrs: {
        options: _vm.attributeItems[attr.id] || [],
        multiple: true,
        label: "name",
        "track-by": "id",
      ...
      on: {
        input: _vm.generateVariants
      },
      model: {
        value: _vm.selectedAttributeValues[attr.id],
        callback: function callback($$v) {
          _vm.$set(_vm.selectedAttributeValues, attr.id, $$v);
        },
        expression: "selectedAttributeValues[attr.id]"
      }
    })], 1);
  }), _vm._v(" "), _c("div", {
    staticClass: "table-responsive"
  }, [_vm.variantList.length ? _c("table", {
    staticClass: "table table-bordered mt-3"
  }, [_vm._m(1), _vm._v(" "), _c("tbody", _vm._l(_vm.variantList, function (variant, index) {
    return _c("tr", {
      key: index
    }, [_c("td", [_vm._v("\n            " + _vm._s(variant.name) + "\n            "), _c("input", {
      attrs: {
        type: "hidden",
        name: "variants[".concat(index, "][name]")
      },
      domProps: {
        value: variant.name
      }
    }), _vm._v(" "), _vm._l(variant.attribute_items, function (id) {
      return _c("input", {
        key: id,
        attrs: {
          type: "hidden",
          name: "variants[".concat(index, "][attribute_items][]")
        },
        domProps: {
          value: id
        }
      });
    }), _vm._v(" "), variant.id ? _c("input", {
      attrs: {
        type: "hidden",
        name: "variants[".concat(index, "][id]")
      },
      domProps: {
        value: variant.id
      }
    }) : _vm._e()], 2), _vm._v(" "), _c("td", [_c("input", {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: variant.sku,
        expression: "variant.sku"
      }],
      staticClass: "form-control",
      attrs: {
        type: "text",
        name: "variants[".concat(index, "][sku]")
      },
      domProps: {
        value: variant.sku
      },
      on: {
        input: function input($event) {
          ...
          _vm.$set(variant, "sku", $event.target.value);
        }
      }
    }), _vm._v(" "), variant.errors && variant.errors.sku ? _c("small", {
      staticClass: "text-danger"
    }, [_vm._v(_vm._s(variant.errors.sku[0]))]) : _vm._e()]), _vm._v(" "), _c("td", [_c("input", {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: variant.price,
    ...
    }), _vm._v(" "), variant.errors && variant.errors.price ? _c("small", {
      staticClass: "text-danger"
    }, [_vm._v(_vm._s(variant.errors.price[0]))]) : _vm._e()]), _vm._v(" "), _c("td", [_c("input", {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: variant.customer_buying_price,
        expression: "variant.customer_buying_price"
      }],
      staticClass: "form-control form-control-sm",
      attrs: {
        type: "number",
        name: "variants[".concat(index, "][customer_buying_price]")
      },
      domProps: {
        value: variant.customer_buying_price
      },
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(variant, "customer_buying_price", $event.target.value);
        }
      }
      ...
      attrs: {
        type: "number",
        name: "variants[".concat(index, "][weight]")
      },
      domProps: {
        value: variant.weight
      },
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: variant.dimension_l,
        expression: "variant.dimension_l"
      }],
      staticClass: "form-control form-control-sm",
      attrs: {
        type: "number",
        placeholder: "L",
        name: "variants[".concat(index, "][dimension_l]")
      },
      domProps: {
        value: variant.dimension_l
      },
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(variant, "dimension_l", $event.target.value);
        }
      }
    }), _vm._v(" "), _c("input", {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: variant.dimension_w,
        expression: "variant.dimension_w"
      }],
      staticClass: "form-control form-control-sm",
      attrs: {
        type: "number",
        placeholder: "W",
        name: "variants[".concat(index, "][dimension_w]")
      },
      domProps: {
        value: variant.dimension_w
      },
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(variant, "dimension_w", $event.target.value);
        }
      }
    }), _vm._v(" "), _c("input", {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: variant.dimension_d,
        expression: "variant.dimension_d"
      }],
      staticClass: "form-control form-control-sm",
      attrs: {
        type: "number",
        placeholder: "D",
        name: "variants[".concat(index, "][dimension_d]")
      },
      domProps: {
        value: variant.dimension_d
      },
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(variant, "dimension_d", $event.target.value);
        }
      }
...
var staticRenderFns = [function () {
  var _vm = this,
    _c = _vm._self._c;
  return _c("label", [_c("strong", [_vm._v("Attribute Sets")])]);
}, function () {
  var _vm = this,
    _c = _vm._self._c;
  ...
  }, [_vm._v("Customer Buying Price")]), _vm._v(" "), _c("th", {
    staticStyle: {
      width: "8%"
    }
  ...
  }, [_vm._v("Dimensions (L × W × D)")]), _vm._v(" "), _c("th", {
    staticStyle: {
      width: "5%"
    }
  }, [_vm._v("Action")])])]);
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-multiselect/dist/vue-multiselect.min.css?vue&type=style&index=0&lang=css&":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-multiselect/dist/vue-multiselect.min.css?vue&type=style&index=0&lang=css& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_vue_multiselect_min_css_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../vue-loader/lib/loaders/stylePostLoader.js!../../postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./vue-multiselect.min.css?vue&type=style&index=0&lang=css& */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-multiselect/dist/vue-multiselect.min.css?vue&type=style&index=0&lang=css&");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_vue_multiselect_min_css_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _style_loader_dist_cjs_js_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_vue_loader_lib_loaders_stylePostLoader_js_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_vue_multiselect_min_css_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../style-loader/dist/cjs.js!../../laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../vue-loader/lib/loaders/stylePostLoader.js!../../postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./vue-multiselect.min.css?vue&type=style&index=0&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-multiselect/dist/vue-multiselect.min.css?vue&type=style&index=0&lang=css&");
