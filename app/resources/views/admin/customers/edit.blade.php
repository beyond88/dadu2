                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="email" name="email" class="form-control" value="{{ $customer->email }}"
                                required {{ $customer->email == 'customer@app.com' ? 'readonly' : '' }}>
                            @error('email')
                            <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="phone" name="phone" class="form-control phone"
                                value="{{ to_bangla_number(old('phone') ?? $customer->phone ?? '+1') }}" required {{ $customer->email == 'customer@app.com' ? 'readonly' : '' }}>
                            @error('phone')
                            <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group col-sm-6">
                            ...
                            <input type="password" name="password" class="form-control" placeholder="Enter password" {{ $customer->email == 'customer@app.com' ? 'readonly' : '' }}>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="password" name="password_confirmation" class="form-control"
                                   placeholder="Type password again" {{ $customer->email == 'customer@app.com' ? 'readonly' : '' }}>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 b_hide_same">
                                    ...
                                    <input type="text" id="phone2" name="b_phone" class="form-control phone"
                                        value="{{ to_bangla_number(old('b_phone') ?? $customer->b_phone ?? '+1') }}">
                                    @error('b_phone')
                                    <p class="error">{{ $message }}</p>
                                    @enderror
                                </div>
