        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-body text-center">
                    <h4 class="text-danger m-0">{{ __('custom.no_warehouse_found') ?? 'No active warehouse found' }}</h4>
                    <p class="text-muted mt-2 mb-0">
                        Please create an active warehouse before creating an invoice.
                        <a href="{{ route('admin.warehouses.create') }}">Create a warehouse</a>
                    </p>
                </div>
            </div>
        </div>
