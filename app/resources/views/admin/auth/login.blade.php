                ...
                <div class="account-box">
                    ...
                    <div class="card-box shadow-none ic_main_form_inner p-4 w-auto">
                        <div class="p-2">
                            ...
                            <form class="mt-4 login_form  ic_main_form_inner w-auto shadow-none p-0" action="{{ url('/admin/login') }}" method="post" id="loginForm" novalidate="novalidate">
                                @csrf
                                <div class="form_box">
                                    <div class="text-left">
                                        <label class="form-label" for="username">Email</label>
                                        <div class="mb-3 form-group">
                                            <input type="email" name="email" class="form-control ic_control_form" id="email" placeholder="Enter username">
                                        </div>

                                        <label class="form-label" for="userpassword">Password</label>
                                        <div class="mb-3 form-group">
                                            <input type="password" name="password" class="form-control ic_control_form" id="password" placeholder="Enter password">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="text-center login-form-footer">
                                © {{ date('Y') }} {{ __('custom.all_right_reserved') }} | {{ __('custom.design_and_developed') }}
                                <a class="ic-main-color" href="https://trivonsystems.com/">
                                    <span class="d-block">Trivon System BD</span>
                                </a>
                            </div>
    ...
    <div class="col-lg-5 col-md-7 m-auto ml-lg-auto">
        <div class="ic_main_form_inner">
            ...
            <div class="text-center login-form-footer">© {{ date('Y') }} {{
                            __('custom.all_right_reserved') }} | {{ __('custom.design_and_developed') }} <a class="ic-main-color" href="https://trivonsystems.com/"><span class="d-block">Trivon System
                        BD</span></a></div>
        </div>
    </div>
    </div>
