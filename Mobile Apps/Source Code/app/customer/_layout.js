...
import CustomerSidebarNav from "../../components/SidebarNav/CustomerSidebarNav";
...
const CustomerLayout = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {isOpen && <CustomerSidebarNav handleMenuClose={handleMenuClose} />}
      <View style={styles.mainContent}>
        <Slot />
      </View>
      <View>
        <BottomTab handleMenuOpen={handleMenuOpen} role="customer" />
      </View>
    </SafeAreaView>
  );
};
