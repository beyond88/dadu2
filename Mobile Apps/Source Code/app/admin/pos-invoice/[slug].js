...
const ViewInvoice = () => {
  ...
  const handleDownloadPDF = async () => {
    ...
    const result = await FileSystem.downloadAsync(
      `${apiUrl}/admin/invoice-download/${slug}`,
        ...
        <View style={styles.invoiceCard}>
          <View style={styles.topTile}>
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                Invoice#{generate8DigitNumber(slug || 0)}
              </Text>
              <Text
                preset="h5_m"
          ...
          <View style={styles.address}>
            ...
            <View style={{ width: "45%" }}>
              ...
              >
                {shipping_info?.address_line_1 || billing_info?.address_line_1},{" "}
                {shipping_info?.address_line_2 || billing_info?.address_line_2}
              </Text>
              <Text
                preset="h6"
                style={{
              ...
              >
                {shipping_info?.email || billing_info?.email}
              </Text>
              <Text
                preset="h6"
                style={{ color: "#727F8B", textAlign: "right" }}
              >
                {shipping_info?.phone || billing_info?.phone}
              </Text>
            </View>
          </View>
          <View>
          ...
          <View style={styles.calculation}>
            <View style={styles.itemCalculation}>
              ...
              >
                {currency_symbol} {discount_amount}
              </Text>
            </View>
            <View style={styles.itemCalculation}>
              <Text
          ...
          {payment_type === "online" && (
            <View style={{ paddingHorizontal: 20, marginBottom: 10 }}>
              <Text preset="h3" style={{ marginBottom: 8 }}>
                Payment Url - Amount : {currency_symbol} {last_paid}
              </Text>
