        ...
        <View>
          ...
          <View style={styles.generateBtnWrap}>
            {selectedFromDate && selectedToDate ? (
              <Link
                href={`/admin/report/payment/list?warehouse=${selectedWareHouse}&fromDate=${selectedFromDate}&toDate=${selectedToDate}`}
              >
            ...
            <Link href={`/admin/report/payment/list?query=all-time`}>
              <View>
                <LinearGradient
