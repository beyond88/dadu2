...
import { useGetPaymentReportQuery } from "../../../../redux/features/report/reportApi";
...
const PaymentList = () => {
  ...
  const {
    ...
    error,
    isError,
  } = useGetPaymentReportQuery({ fromDate, toDate, warehouse, query });
        ...
        <View>
          <View style={styles.reportInfoCard}>
            ...
            <Text preset="h3_r" style={[styles.infoItem, styles.borderNone]}>
              ...
              {paymentReportData?.data?.total || "0.00"}
            </Text>
          </View>
