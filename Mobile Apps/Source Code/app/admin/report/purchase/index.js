        ...
        <View>
          ...
          <View style={styles.generateBtnWrap}>
            {selectedFromDate && selectedToDate ? (
              <Link
                href={`/admin/report/purchase/list?warehouse=${selectedWareHouse}&fromDate=${selectedFromDate}&toDate=${selectedToDate}`}
              >
            ...
            <Link href={`/admin/report/purchase/list?query=all-time`}>
              <View>
                <LinearGradient
