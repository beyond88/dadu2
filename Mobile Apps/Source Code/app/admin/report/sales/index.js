        ...
        <View>
          ...
          <View style={styles.generateBtnWrap}>
            {selectedFromDate && selectedToDate ? (
              <Link
                href={`/admin/report/sales/list?warehouse=${selectedWareHouse}&fromDate=${selectedFromDate}&toDate=${selectedToDate}`}
              >
            ...
            <Link href={`/admin/report/sales/list?query=all-time`}>
              <View>
                <LinearGradient
