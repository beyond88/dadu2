        ...
        <View>
          ...
          <View style={styles.generateBtnWrap}>
            {selectedFromDate && selectedToDate ? (
              <Link
                href={`/admin/report/loss-profit/list?warehouse=${selectedWareHouse}&fromDate=${selectedFromDate}&toDate=${selectedToDate}`}
              >
            ...
            <Link href={`/admin/report/loss-profit/list?query=all-time`}>
              <View>
                <LinearGradient
