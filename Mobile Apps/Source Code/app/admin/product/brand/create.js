...
import { useCreateBrandMutation } from "../../../../redux/features/brandApi/brandApi";
...
const BrandCreate = () => {
  ...
  const [
    createBrand,
    { data: createBrandData, isLoading, isError, error, isSuccess },
  ...
  useEffect(() => {
    if (isSuccess) {
      showMessage({
        message: createBrandData.message,
        type: "success",
      });
  ...
  }, [createBrandData, isSuccess, isError, error]);
