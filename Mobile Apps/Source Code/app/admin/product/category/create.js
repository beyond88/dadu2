...
const CategoryCreate = () => {
  ...
  const [
    createCategory,
    { data: createCategoryData, isLoading, isError, error, isSuccess },
  ...
  const onSubmit = (data) => {
    ...
    formData.append("parent_id", data.parentCategory || "");
  ...
  useEffect(() => {
    if (isSuccess) {
      showMessage({
        message: createCategoryData.message,
        type: "success",
      });
  ...
  }, [createCategoryData, isSuccess, isError, error]);
