...
import { useSalesReturnListDetailsQuery } from "../../../../../redux/features/sales-return/salesReturnApi";
...
const ReturnListShow = () => {
  ...
  const { data: salesReturnListDetails } = useSalesReturnListDetailsQuery(slug);
  const { invoice, sale_return_items } = salesReturnListDetails?.data || {};
  ...
  return (
    <>
      <Topbar title="Return List Details" />
      <ScrollView style={{ paddingHorizontal: 20, marginBottom: 180 }}>
        <View style={styles.invoiceCard}>
          ...
          <View>
            ...
            >
              {sale_return_items?.map((item, index) => (
