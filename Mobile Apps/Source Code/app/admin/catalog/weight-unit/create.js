...
import { useCreateWeightUnitMutation } from "../../../../redux/features/catalog/catalogApi";
...
const WeightUnitCreate = () => {
  //create category mutation
  const [
    createWeightUnit,
    { data: createWeightUnitData, isLoading, isError, error, isSuccess },
  ...
  useEffect(() => {
    if (isSuccess) {
      showMessage({
        message: createWeightUnitData.message,
        type: "success",
      });
  ...
  }, [createWeightUnitData, isSuccess, isError, error]);

  return (
    <>
      {isLoading && <Loading />}
      <Topbar title="Create weight unit" />
...
export default WeightUnitCreate;
