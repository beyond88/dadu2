                                        ...
                                        <table width="100%" class="table table-sm table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><strong>{{ __('custom.product_name') }}</strong></th>
                                                    <th><strong>{{ __('custom.brand') }}</strong></th>
                                                    <th><strong>{{ __('custom.parts_no') }}</strong></th>
                                                    <th><strong>{{ __('custom.model') }}</strong></th>
                                                    <th><strong>{{ __('custom.price') }}</strong></th>
                                                    <th><strong>{{ __('custom.discount') }}</strong></th>
                                                    <th><strong>{{ __('custom.sub_total') }}</strong></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @if ($invoice->items)
                                                ...
                                                @if ($invoice->payments)
                                                    @foreach ($invoice->payments as $item)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ in_array(strtolower($item->payment_type), ['bank', 'online']) ? (\App\Models\Account::find($item->bank_name)?->name ?? '-') : '-' }}</td>
                                                        </tr>
                                                    @endforeach
                                                @endif
                                            </tbody>
