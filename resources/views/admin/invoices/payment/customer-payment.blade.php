        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="header-title mb-0">{{ __t('make_payment') }} — {{ $customer->full_name }}</h4>
                    <a href="{{ route('admin.customers.payment.history', $customer->id) }}" class="btn btn-sm btn-outline-primary">
                ...
                {{-- @if($due <= 0)
                    <div class="alert alert-success">
                        <i class="fa fa-check-circle"></i> {{ __t('fully_paid_customer') ?? 'All invoices for this customer are fully paid.' }}
                    </div>
                @endif --}}

                <form action="{{ route('admin.customers.payment.store', $customer->id) }}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        {{-- Payment type is not asked for: the selected account is the
                             payment method, so it is derived from that account. --}}
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="notes" class="form-control" value="{{ old('notes') }}" placeholder="Add a note for this collection...">
                    ...
                    <div class="mt-3 d-flex gap-2">
                        ...
                        <a href="{{ route('admin.customers.index') }}" class="btn btn-danger ml-2">
