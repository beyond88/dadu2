                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 d-print-none">
                            ...
                            <a class="btn btn-info float-right mr-2" href="{{ route('admin.sales-return.requests') }}"><i
                            ...
                            <div class="col-sm-6">
                                ...
                                <table class="ic-purchase-print" width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>{{ optional($billing_info)->address_line_1 ?? optional($billing_info)->address }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><b>{{ __t('city') }}</b></td>
                                        <td>:</td>
                                        <td>{{ optional($billing_info)->city }}</td>
                                    </tr>
                                    <tr>
                                        <td><b>{{ __t('zip') }}</b></td>
                                        <td>:</td>
                            ...
                            <div class="col-sm-6">
                                ...
                                <table class="ic-purchase-print" width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td><b>{{ __t('address_line_1') }}</b></td>
                                        <td>:</td>
                                        <td>{{ optional($shipping_info)->address_line_1 ?? optional($shipping_info)->address }}</td>
                                    </tr>
                                    <tr>
                                        <td><b>{{ __t('address_line_2') }}</b></td>
                                        <td>:</td>
                                    ...
                                    <tr>
                                        <td><b>{{ __t('city') }}</b></td>
                                        <td>:</td>
                                        <td>{{ optional($shipping_info)->city }}</td>
                                    </tr>
                                    <tr>
                                        <td><b>{{ __t('zip') }}</b></td>
                                        <td>:</td>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        @foreach($sale_return->saleReturnRequestItems as $key => $returnItems)
                                            <tr>
                                                ...
                                                <td>{{ $returnItems->return_qty }}@if($returnItems->product->is_weight_based)<small class="text-muted">/{{ $returnItems->product->barrel_label ?: __('custom.barrels') }}</small>@endif</td>
                                                <td class="text-right">{{ currencySymbol().make2decimal($returnItems->return_price) }}@if($returnItems->product->is_weight_based)<small class="text-muted">/{{ $returnItems->product->barrel_label ?: __('custom.barrels') }}</small>@endif</td>
