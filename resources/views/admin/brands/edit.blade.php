    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ __('custom.edit_brand') }}</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">{{ __('custom.edit_brand') }}</h4>
                <form class="form-validate" action="{{ route('admin.brands.update', $brand->id) }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <img class="img-32" src="{{ $brand->file_url }}" alt="images" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="status_yes" value="{{ \App\Models\Brand::STATUS_ACTIVE }}"
                                    ...
                                    @if(\App\Models\Brand::STATUS_ACTIVE==$brand->status) checked @endif>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="status_no" value="{{ \App\Models\Brand::STATUS_INACTIVE }}"
                                    name="status" class="custom-control-input"
                                    @if(\App\Models\Brand::STATUS_INACTIVE==$brand->status) checked @endif>
