                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="investor_phone" id="investor_phone" class="form-control @error('investor_phone') is-invalid @enderror" value="{{ old('investor_phone', $capital->investor_phone) }}">
