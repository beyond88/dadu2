                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>{{ __('custom.booking_info') }}</label>
                                            <textarea name="general[booking_info]" class="form-control" rows="3"
                                                placeholder="Booking No. : Mob. : 01955-903400 (A. Rashid)">{{ $settings['general']['booking_info'] ?? '' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="api_key" class="form-control"
                                                value="{{ is_array($settings['api_key'] ?? null) ? '' : ($settings['api_key'] ?? '') }}">
                                        </div>
                                    </div>
                                </div>
