                ...
                <div class="modal-body">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <select name="payment_type" id="modal-invoice-payment-type" class="form-control" required>
                                <option value="cash">{{ __('custom.cash') }}</option>
                                <option value="bank">{{ __('custom.bank') }}</option>
                                <option value="online">{{ __('custom.online') }}</option>
                            </select>
                            @error('payment_type')
                            <p class="error">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="col-sm-12" id="modal-bank-selection-wrapper" style="display: none;">
                        <div class="form-group">
                            <label for="">{{ __('custom.bank_name') }} <span class="error">*</span></label>
                            <select name="bank_info[bank_name]" class="form-control">
...
@push('script')
<script>
    $(document).on('change', '#modal-invoice-payment-type', function() {
        var type = $(this).val();
        if (type == 'bank' || type == 'online') {
            $('#modal-bank-selection-wrapper').show();
            $('#modal-bank-selection-wrapper select').attr('required', true);
        } else {
            $('#modal-bank-selection-wrapper').hide();
            $('#modal-bank-selection-wrapper select').attr('required', false);
        }
    });
</script>
@endpush
