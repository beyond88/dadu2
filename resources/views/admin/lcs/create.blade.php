...
@section('content')
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">{{ __('custom.add_lc') }}</h4>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ __('custom.add_lc') }}</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <form action="{{ route('admin.lcs.store') }}" method="POST" class="ic-lc-form">
                @csrf
                <div class="card">
                    <div class="card-body">
