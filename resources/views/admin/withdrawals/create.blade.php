...
@section('content')
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#" class="ic-javascriptVoid">{{ __('custom.withdraw') }}</a>
                    </li>
                    <li class="breadcrumb-item active">{{ __('custom.add_withdraw') }}</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card card-body">
                    <div class="row">
                        <div class="col-sm-12 col-lg-3">
                            <form action="" id="withdrawalCreate">
                                <div class="form-group">
                                    <select name="warehouse" id="withdrawalCreateWarehouse" class="form-control select2"
                                            onchange="">
    ...
    @if(count($warehouses) > 1 && request('warehouse'))
        ...
        <div class="row">
            <div class="col-sm-12">
                <storekeeper-withdrawal-add app_name="{{ config('site_title') ?? config('app.name') }}" default_tax="{{ getDefaultTax() }}"
